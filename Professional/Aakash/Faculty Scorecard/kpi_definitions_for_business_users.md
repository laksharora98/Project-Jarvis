...
*   **How it's calculated:** We look at all the tests taken by a faculty's mapped students. We calculate the percentage of those tests where the students' scores were higher than the national average score for that same test and subject.
...
*   **How it's calculated:** This is the percentage of students, on average, who were present for each class taught by the faculty.
...
*   **How it's calculated:** This is the percentage of assigned tests that were actually attempted by the faculty's mapped students.
...
*   **How it's calculated:** This is the percentage of a faculty's total lectures for which they have gone into the system and marked the syllabus topics as "completed."
...
*   **How it's calculated:** This is the percentage of a faculty's total lectures for which they have marked student attendance in the system.
*   **Attribution Window:** 0 days. Only lectures delivered during the teaching period are considered.
...
*   **How it's calculated:** This is the average rating (on a scale of 1 to 5) that a faculty receives from their mapped students through official feedback surveys.
...
*   **How it's calculated:** This score is based on the percentage of a faculty's mapped students who did **not** discontinue their studies with Aakash. A higher percentage (fewer students leaving) results in a higher score.
...
*   **How it's calculated:** This is the percentage of a faculty's mapped students who, after completing their course, successfully enrolled in a subsequent course at Aakash.
